...
export default function MainHeader() {
  ...
  const tools = [
    ...
    { id:2, name:"Image Finder", ToolLink : "/imagefinder" },
    { id:3, name:"Stalk Social Media", ToolLink : "/socialmedia" },
    { id:4, name:"PhoneNumber Information", ToolLink : "/phone" },
  ];
  ...
  return (
    <div className='p-3 flex flex-row justify-between items-center bg-[#0F0F11] border-b border-[#232329]'>
      ...
      {/* Logo */}
      <Image src={'/vepng.png'} width={120} height={120} alt='vecura' />

      {/* Desktop Navigation */}
      <div className='hidden md:flex flex-row gap-10 p-4 text-white font-normal items-center'>
        <Link href={'/'}>
          <h1 className='hover:border-b hover:border-gray-50 cursor-pointer'>What is Vercura?</h1>
        </Link>

        <Link href={'/'}>
          <h1 className='hover:border-b hover:border-gray-50 cursor-pointer'>How To Use</h1>
        </Link>
